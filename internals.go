...
func (int *DangerousInternalClient) HandleGroupedReceipt(partialReceipt events.Receipt, participants *waBinary.Node, fallbackMessageID types.MessageID) (cancelled bool) {
	return int.c.handleGroupedReceipt(partialReceipt, participants, fallbackMessageID)
}
