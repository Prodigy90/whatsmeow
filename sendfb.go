...
func (cli *Client) encryptMessageForDevicesV3(
	...
	// #1168: see encryptMessageForDevices for the locking rationale.
	...
	if len(retryDevices) > 0 {
		// See encryptMessageForDevices — release the locks across the network
		// prekey fetch, then re-read sessions after re-locking.
		unlockSessions()
		unlockSessions = func() {}
